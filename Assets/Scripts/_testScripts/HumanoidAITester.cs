...
public class HumanoidAITester : MonoBehaviour
{
    ...
    public void FindWeapon()
    {
        ...
        foreach (Collider col in cols) { 
            ...
            if(col.GetComponent<Weapon>() != null){
                ...
                if(weapon.Owner.CombatInventory == null)
                {
                    targetWeapon = weapon;
    ...
    private void GoToWeapon()
    {
        ...
        if (targetWeapon.Owner.CombatInventory != null) aiMotor.StopMovement();
    ...
    private void GoToShield()
    {
        ...
        if (targetShield.Owner.CombatInventory != null) aiMotor.StopMovement();
